...
public class MainFrame2 extends JFrame{
	...
	ActionListener sendListener=new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showConfirmDialog(MainFrame2.this, "전송합니다.");
		}
	};
	ActionListener updateListener=(e)->{
		JOptionPane.showConfirmDialog(MainFrame2.this, "수정합니다.");
	};
	ActionListener deleteListener=(e)->{
		JOptionPane.showConfirmDialog(MainFrame2.this, "삭제합니다.");
	};
