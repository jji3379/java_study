 ...
 *	3. DeptDto 를 완성해 보세요.						
 *	4. DeptDao 를 완성해 보세요.						
 *	5. 위에 완성된 DeptDao 를 이용해서 아래 DeptFrame을 구현해 보세요.
 */
public class DeptFrame extends JFrame implements ActionListener{
	//필드 
	JTextField text_deptno, text_dname, text_loc;
	...
	public static void main(String[] args) {
		DeptFrame f=new DeptFrame("사원정보 관리");
		...
		public void deleteDept() {
			...
			if(selectedIndex ==-1) {
				...
				//삭제하기전에 한번 확인하기
				int result=JOptionPane.showConfirmDialog(this, deptno+" 번 회원을 삭제할겨?");
